...
Revision ID: e87f30fdeec6
Revises: 8d214e2890df
Create Date: 2025-06-13 23:24:01.546395
...
revision: str = 'e87f30fdeec6'
down_revision: Union[str, None] = '8d214e2890df'
...
def downgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('pending', 'paid', 'cancelled', name='orderstatusenum'), autoincrement=False, nullable=True),
